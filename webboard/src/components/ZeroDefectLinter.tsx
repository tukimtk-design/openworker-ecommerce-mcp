        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <button
              ...
              className="mt-4 w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-4 rounded-lg transition-colors cursor-pointer"
            >
              Lint Schema
            </button>
          </div>
                ...
                {result.messages.map((msg, idx) => (
                  <div
                    ...
                    className={`flex items-start gap-2 ${
                      msg.includes('[Error]') || msg.includes('Invalid') || msg.includes('กรุณา')
                        ? 'text-red-400'
                        : 'text-emerald-400'
                    }`}
                  >
